...
| `last_verified` | string (ISO 8601 date) | Yes | Date the entry was last confirmed accurate. Only set a real date if you can stand behind the location. | `"2024-06-15"` |
